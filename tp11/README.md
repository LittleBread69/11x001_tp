...
**TODO** : Le tableau ``arr`` contient des valeurs que nous souhaitons stocker dans une liste:
- Implémenter une liste chaînée ainsi que les fonctions permettant de créer une liste chaînée et d'y insérer une valeur.
- Créer une liste chaînée et y insérer les valeurs lues lors du parcours de `arr`
- Parcourir la liste chaînée afin de calculer la moyenne de ses valeurs et afficher le résultat.
